# dataset settings
dataset_type = "KiwiScapesDataset"
data_root = "datasets/kiwiscapes/"
crop_size = (384, 640)  # (1024,1024) #
train_pipeline = [
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        data_prefix=dict(img_path="images/valid", seg_map_path="labels/valid"),
